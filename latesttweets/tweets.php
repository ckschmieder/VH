<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		$tweet_wrap_open     = '<li>',
		$tweet_time_wrap_open= '<li class="time">',
		...
		$consumerkey         = "zeFtOQh41X4wS0Hd6kMb5bjVE";
		$consumersecret      = "2xdT2rW99sXpIPg3KHlRaRZDvYKqW4PIOx7dNEyLxbCZf3ZxO0";
		$accesstoken         = "2882999170-GB7eNWC2QrMTzvIRxa4GpQ8cj4dqZZSyLouzhkq";
		$accesstokensecret   = "cbVo3CSh0Eu2gjuFSufbCmvN4GebCCv0xbNbhVWb2cKnw";
			...
			if($connection){
				...
				if (count($get_tweets)) {
					...
					foreach($get_tweets as $tweet) {
							...
							// Render the tweet.
							$twitter_html .= '<div class="text"><div class="logo"></div><a href="http://twitter.com/'.$twitter_user_id.'"><div class="name">Brooks Brothers <span>@'.$twitter_user_id.'</span></div></a><p>'.$tweet_desc.'</p><a href="http://twitter.com/'.$twitter_user_id.'">'.$display_time.'</a></div>';
	...
	display_latest_tweets('BrooksBrothers');
?>