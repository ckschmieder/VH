...
get_header(); ?>
 ...
 -->
		<div class="row">
			<h1 class="page-title search-page-title"><?php printf( esc_html__( 'Search Results for vh search: %s' ), '<span class="search-term">"' . get_search_query() . '"</span>' ); ?></h1>
		...
		<div class="category-list display alph">
	        ...
	        <?php else : ?>
	        	...
	        	<div>No products found. vh search.php</div>
